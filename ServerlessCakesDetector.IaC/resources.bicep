...
@maxLength(16)
@minLength(3)
param environmentName string = 'scd${uniqueString(subscription().id, resourceGroup().name)}'
...
resource appSettings 'Microsoft.Web/sites/config@2022-03-01' = {
  ...
  properties: {
    ...
    'ImageAnalyzer:PredictionEndpoint': '@Microsoft.KeyVault(SecretUri=${cognitiveServicePredictionEndpointSecret.properties.secretUri})'
    'ImageAnalyzer:PredictionKey': '@Microsoft.KeyVault(SecretUri=${cognitiveServicePredictionApiKeySecret.properties.secretUri})'
    'ImageAnalyzer:ProjectID':'<set project id here>'
    'ImageAnalyzer:ModelName':'<set model name here>'
